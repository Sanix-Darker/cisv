...
All bindings use the same SIMD-optimized C core. Real-world overhead depends on marshaling costs and workload shape (full parse vs row-count-only paths).

For current measured numbers and methodology, use the per-binding reports generated by CI:
- [CLI benchmarks](../BENCHMARKS_CLI.md)
- [Node.js benchmarks](../BENCHMARKS_NODEJS.md)
- [Python benchmarks](../BENCHMARKS_PYTHON.md)
- [PHP benchmarks](../BENCHMARKS_PHP.md)
